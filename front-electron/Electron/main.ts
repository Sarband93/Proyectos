...
import { appConfig } from './ElectronStore/Configuration.ts';
import AppUpdater from './AutoUpdate.ts';
...
async function createWindow() {
    ...
    await mainWindow.loadURL(isDev ? 'http://localhost:5173' : `file://${path.join(__dirname, './index.html')}`);
