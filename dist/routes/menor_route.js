...
function routing(app) {
    ...
    app.post('/post-inserta-lista', menor_controller_1.default.insertarVariosMenores);
    // GET LISTA MENORES
    app.get('/menores', menor_controller_1.default.getListaMenores);
    // GET LISTA MENORES POR GRUPO
    app.get('/menores/grupo/:nombreGrupo', menor_controller_1.default.buscarMenorPorGrupo);
    // GET LISTA MENORES POR APELLIDO
    app.get('/menores/apellido/:apellido', menor_controller_1.default.buscarMenorPorApellido);
