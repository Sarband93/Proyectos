...
const BadRequestError_1 = __importDefault(require("../server/errors/BadRequestError"));
...
async function modificarMenor(req, res, next) {
    try {
        ...
        const menorActualizado = await menor_model_1.Menor.findByIdAndUpdate(id, { nombre, apellido, edad, grupo }, { new: true } // Devuelve el objeto actualizado
        );
        if (!menorActualizado) {
