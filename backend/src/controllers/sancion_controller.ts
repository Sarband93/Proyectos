...
// Obtener todas las sanciones (opcionalmente filtradas por menorId)
export const getSanciones = async (
    ...
    try {
        ...
        if (menorId) {
            filtro.menorId = menorId;
        }

        // Solo mostramos sanciones activas si NO se pasa el parámetro incluirInactivas
        if (!incluirInactivas || incluirInactivas === 'false') {
            filtro.activa = true;
        }
...
// Eliminar sanción (marcar como inactiva)
